...
def main():
    # URL страницы
    real_url = "https://www.banki.ru/services/responses/bank/promsvyazbank/"
    ...
    while execute is True:
        ...
        if response.status_code == 200:
            ...
            exist_button = soup.find_all("a",
                                         attrs={"class": "l32fd617a l05f8f162 l973b129a l0b4a5b1c l86873e09"})
            if len(exist_button):
                execute = True
            else:
                execute = False
